...
const Projects = () => {
  return (
    <div className=" ">
                <div className="mb-[50px] flex p-1 justify-around items-center flex-wrap mt-[70px] bg-black">
                    {projectInfo.map((item, index) => (
                        <div
                            className=" text-center m-10  bg-black p-4 shadow-[0_20px_80px_20px_rgba(0,0,0)] rounded-xl border-[white] border-solid border-2"
                            key={index}
                        >
